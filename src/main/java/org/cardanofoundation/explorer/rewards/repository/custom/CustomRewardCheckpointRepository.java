...
public class CustomRewardCheckpointRepository {
  ...
  @Transactional
  public void saveCheckpoints(List<RewardCheckpoint> rewardCheckpoints) {
    String sql = "INSERT INTO reward_checkpoint (id, view, epoch_checkpoint) "
