...
class RewardControllerTest {
  ...
  @MockBean
  private RewardConcurrentFetching mockRewardConcurrentFetching;
  ...
  void fetchRewards_Success_ReturnsTrue() throws Exception {
    ...
    when(mockRewardConcurrentFetching.fetchDataConcurrently(stakeAddressList))
        .thenReturn(true);
    mockMvc.perform(post("/api/v1/rewards/fetch")
            .content(asJsonString(stakeAddressList)).contentType(MediaType.APPLICATION_JSON)
